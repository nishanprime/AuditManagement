                ...
                <div className="card-body box-profile">
                  ...
                  <ul className="list-group list-group-unbordered mb-3">
                    <li className="list-group-item">
                      <b>Followers</b>{" "}
                      <Link className="float-right">1,322</Link>
                    </li>
                    <li className="list-group-item">
                  ...
                  <div className="tab-content">
                    <div className="active tab-pane" id="activity">
                      ...
                      <div className="post">
                        ...
                        {/* <!-- /.user-block --> */}
                        <p>
                          Lorem ipsum represents Link long-held tradition for
                      ...
                      <div className="post clearfix">
                        <div className="user-block">
                          ...
                          <span className="description">
                            Sent you Link message - 3 days ago
                          </span>
                        </div>
                        {/* <!-- /.user-block --> */}
                        <p>
                      ...
                      <div className="timeline timeline-inverse">
                        ...
                        <div>
                          ...
                          <div className="timeline-item">
                            ...
                            <h3 className="timeline-header border-0">
                              <Link to="#">Sarah Young</Link> accepted your
                              friend request
                            </h3>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="timeline-item">
                            ...
                            <h3 className="timeline-header">
                              <Link to="#">Jay White</Link> commented on your
                              post
                            </h3>
